---
title: "PE hedging stragetgy estimation using mboost package"
...
knitr::opts_chunk$set(collapse=TRUE, warning=FALSE, message=TRUE, 
                      fig.width=14, dpi=90)
do.cache <- FALSE
```
...
```{r Prologue, warning=FALSE, message=FALSE}
...
```{r Prepare Pseudo X, cache=do.cache}
type <- "VC_EW"
max.vintage <- 2010
lambda <- 0.025 / 12 
...
```{r boosting, cache=do.cache, fig.keep='first'}
# boosting -----
types <- c("VC_EW", "VC_VW")
...
```{r construct return series, fig.align="center", fig.width=20, fig.height=10, fig.cap="Figure: Here is a really important caption."}
# construct return series -----
